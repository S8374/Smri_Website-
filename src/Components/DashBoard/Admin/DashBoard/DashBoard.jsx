...
export default function DashBoard() {
    ...
    return (
        <div className="p-6 bg-gray-100 dark:text-black w-full min-h-screen">

            <div className="grid grid-cols-1 dark:text-black sm:grid-cols-2 md:grid-cols-3 gap-6 shadow-lg bg-white rounded-lg p-6 mb-8">
                <div className="stat flex flex-col items-center text-center p-6 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl shadow-md">
                    <div className="stat-title dark:text-black  text-lg sm:text-xl font-semibold">Total Sell</div>
                    <div className="stat-value dark:text-black text-3xl font-bold">${totalEarnings.toLocaleString()}</div>
                    <div className="stat-desc dark:text-black text-sm opacity-90">Total earnings from sales</div>
                </div>
                <div className="stat flex flex-col dark:text-black items-center text-center p-6 bg-gradient-to-r from-green-400 to-teal-500 text-white rounded-xl shadow-md">
                    <div className="stat-title dark:text-black text-lg sm:text-xl font-semibold">Total Orders</div>
                    <div className="stat-value dark:text-black text-3xl font-bold">{totalOrders}</div>
                    <div className="stat-desc dark:text-black text-sm opacity-90">Total orders placed</div>
                </div>
            ...
            <div className="mb-8 w-full overflow-x-auto dark:text-black bg-white p-6 rounded-lg shadow-lg">
